        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
          {services.map((service, index) => (
            <motion.div key={index} initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }}
              ...
              whileHover={{ y: -6, scale: 1.01 }} className="group relative">
              ...
              <div className="relative bg-white/80 backdrop-blur-sm p-6 rounded-2xl h-full flex flex-col border border-border group-hover:border-primary/30 shadow-sm group-hover:shadow-xl transition-all duration-300">
                {/* Gradient top border */}
                ...
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-primary/15 to-primary/5 flex items-center justify-center mb-4 group-hover:from-primary/25 group-hover:to-primary/10 group-hover:scale-110 transition-all duration-300">
